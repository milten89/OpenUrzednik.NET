...
/// </summary>
public sealed class ServiceUnavailableException : OpenUrzednikException
{
    /// <summary>
    ...
    public ServiceUnavailableException(string message)
        : base(ServiceUnavailableError.ErrorCode, message) { }
    ...
    public ServiceUnavailableException(string message, Exception innerException)
        : base(ServiceUnavailableError.ErrorCode, message, innerException) { }
}
