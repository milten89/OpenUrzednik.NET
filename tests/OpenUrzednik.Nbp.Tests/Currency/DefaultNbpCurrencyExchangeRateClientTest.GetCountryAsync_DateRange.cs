...
public partial class DefaultNbpCurrencyExchangeRateClientTest
{
    ...
    [InlineData("")]
    [InlineData("US")]
    public async Task GetCountryAsync_DateRange_InvalidCurrency_ReturnsFailureWithoutSendingRequest(string? currency)
    {
        // Arrange
        ...
        // Act
        var result = await sut.GetCountryAsync(currency!, from, to, TestContext.Current.CancellationToken);
    ...
    [Fact]
    public async Task GetCountryAsync_DateRange_ToDateBeforeMinDate_ReturnsFailureWithoutSendingRequest()
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
    ...
    [Fact]
    public async Task GetCountryAsync_DateRange_ExceedsMaxDays_ReturnsFailureWithoutSendingRequest()
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
        var currency = faker.Finance.Currency().Code;
    ...
    [Fact]
    public async Task GetCountryAsync_DateRange_ToDateBeforeMinDateAndRangeExceedsMaxDays_ReturnsCombinedValidationErrorsWithoutSendingRequest()
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
        var currency = faker.Finance.Currency().Code;
    ...
    [Fact]
    public async Task GetCountryAsync_DateRange_SuccessfulResponse_ReturnsMappedCountryExchangeRates()
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
        var currency = faker.Finance.Currency().Code;
    ...
    [Fact]
    public async Task GetCountryAsync_DateRange_HttpRequestFails_ReturnsFailureWithoutAttemptingMapping()
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
        var currency = faker.Finance.Currency().Code;
