...
public partial class DefaultNbpCurrencyExchangeRateClientTest
{
    ...
    public void Ctor_4Args_NullHttpClient_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new DefaultNbpCurrencyExchangeRateClient(null!, urlBuilderFactory, null, null))
    ...
    public void Ctor_4Args_NullUrlBuilderFactory_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new DefaultNbpCurrencyExchangeRateClient(httpClient, null!, null, null))
    ...
    public void Ctor_5Args_NullTimeProvider_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new DefaultNbpCurrencyExchangeRateClient(httpClient, urlBuilderFactory, null!, null, null))
    ...
    public void Ctor_4Args_UsesSystemTimeProvider()
    {
        ...
        // Act
        var sut = new DefaultNbpCurrencyExchangeRateClient(httpClient, urlBuilderFactory, null, null);
    ...
    public void Ctor_5Args_UsesNullLoggerAndTraceSource()
    {
        ...
        // Act
        var sut = new DefaultNbpCurrencyExchangeRateClient(httpClient, urlBuilderFactory, timeProvider, null, null);
