...
public partial class DefaultNbpExchangeRateTableClientTest
{
    ...
    public async Task GetLatestAsync_StartsSpanWithTableTag()
    {
        ...
        // Act
        await sut.GetLatestAsync(MidTableType.A, TestContext.Current.CancellationToken);

        // Assert
        tracer.Received(1).StartSpan("nbp.table.latest");
        span.Received(1).SetTag("nbp.table", MidTableType.A);
    }
    ...
    public async Task GetLatestAsync_InvalidTable_LogsDebugAndRecordsErrorsOnSpan()
    {
        ...
        // Act
        await sut.GetLatestAsync((MidTableType)99, TestContext.Current.CancellationToken);
    ...
    public async Task GetTopCountAsync_StartsSpanWithTags()
    {
        ...
        // Act
        await sut.GetTopCountAsync(MidTableType.A, count, TestContext.Current.CancellationToken);
    ...
    public async Task GetTodayAsync_StartsSpanWithTableTag()
    {
        ...
        // Act
        await sut.GetTodayAsync(MidTableType.A, TestContext.Current.CancellationToken);
    ...
    public async Task GetAsync_Date_StartsSpanWithTags()
    {
        ...
        // Act
        await sut.GetAsync(MidTableType.A, date, TestContext.Current.CancellationToken);
    ...
    public async Task GetAsync_DateRange_StartsSpanWithTags()
    {
        ...
        // Act
        await sut.GetAsync(MidTableType.A, from, to, TestContext.Current.CancellationToken);
