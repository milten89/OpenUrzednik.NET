...
public partial class NbpExchangeRateTableClientTest
{
    ...
    public async Task GetAsync_Date_InvalidTable_ReturnsFailureWithoutSendingRequest(TableType table)
    {
        // Arrange
    ...
    public async Task GetAsync_Date_DateBeforeMinDate_ReturnsFailureWithoutSendingRequest(int year, int month, int day)
    {
        ...
        // Act
        var result = await sut.GetAsync(TableType.A, new DateOnly(year, month, day), TestContext.Current.CancellationToken);
    ...
    public async Task GetAsync_Date_InvalidTableAndDateBeforeMinDate_ReturnsCombinedValidationErrorsWithoutSendingRequest()
    {
        ...
        // Act
        var result = await sut.GetAsync((TableType)99, date, TestContext.Current.CancellationToken);
    ...
    public async Task GetAsync_Date_SuccessfulResponse_ReturnsMappedExchangeRateTable()
    {
        ...
        // Act
        var result = await sut.GetAsync(TableType.A, date, TestContext.Current.CancellationToken);
