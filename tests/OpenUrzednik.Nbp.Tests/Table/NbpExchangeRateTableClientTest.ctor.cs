...
public partial class NbpExchangeRateTableClientTest
{
    ...
    public void Ctor_4Args_NullHttpClient_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new NbpExchangeRateTableClient(null!, urlBuilderFactory, null, null))
    ...
    public void Ctor_4Args_NullUrlBuilderFactory_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new NbpExchangeRateTableClient(httpClient, null!, null, null))
    ...
    public void Ctor_5Args_NullHttpClient_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new NbpExchangeRateTableClient(null!, urlBuilderFactory, timeProvider, null, null))
            .ParamName.ShouldBe("httpClient");
    }
    ...
    public void Ctor_5Args_NullUrlBuilderFactory_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new NbpExchangeRateTableClient(httpClient, null!, timeProvider, null, null))
            .ParamName.ShouldBe("urlBuilderFactory");
    }
    ...
    public void Ctor_5Args_NullTimeProvider_ThrowArgumentNullException()
    {
        ...
        // Act && Assert
        Should.Throw<ArgumentNullException>(() => new NbpExchangeRateTableClient(httpClient, urlBuilderFactory, null!, null, null))
    ...
    public void Ctor_4Args_UsesSystemTimeProvider()
    {
        ...
        // Act
        var sut = new NbpExchangeRateTableClient(httpClient, urlBuilderFactory, null, null);
    ...
    public void Ctor_5Args_UsesNullLoggerAndTraceSource()
    {
        ...
        // Act
        var sut = new NbpExchangeRateTableClient(httpClient, urlBuilderFactory, timeProvider, null, null);
