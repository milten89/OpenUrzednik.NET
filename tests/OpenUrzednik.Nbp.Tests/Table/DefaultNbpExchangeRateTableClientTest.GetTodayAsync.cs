...
public partial class DefaultNbpExchangeRateTableClientTest
{
    ...
    public async Task GetTodayAsync_InvalidTable_ReturnsFailureWithoutSendingRequest(MidTableType table)
    {
        // Arrange
    ...
    public async Task GetTodayAsync_SuccessfulResponse_ReturnsMappedExchangeRateTableFromFirstArrayElement(MidTableType table)
    {
        // Arrange
        var faker = new Faker().WithConstantSeed();
