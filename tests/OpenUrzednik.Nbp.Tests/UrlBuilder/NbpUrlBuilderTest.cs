...
public class NbpUrlBuilderTest
{
    [Fact]
    public void Ctor_NullBaseUrl_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() => new NbpUrlBuilder(null!))
    ...
    {
        // Arrange && Act
        var sut = new NbpUrlBuilder(baseUrl);
    ...
    {
        // Arrange
        var sut = new NbpUrlBuilder("exchangerates/tables/a");
