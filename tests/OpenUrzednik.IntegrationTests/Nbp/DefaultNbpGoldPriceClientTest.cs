...
public class DefaultNbpGoldPriceClientTest : IClassFixture<NbpHttpClientFixture>
{
    private readonly HttpClient _httpClient;
    private readonly DefaultNbpUrlBuilderFactory _urlBuilderFactory = new();
    private readonly DefaultNbpGoldPriceClient _client;

    public DefaultNbpGoldPriceClientTest(NbpHttpClientFixture fixture)
    {
        _httpClient = fixture.HttpClient;
        _client = new DefaultNbpGoldPriceClient(_httpClient, _urlBuilderFactory);
    }
